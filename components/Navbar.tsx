...
const Navbar = () => {
  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[10vh] sticky top-0 z-50 bg-bodyColor px-10">
      <div className="max-w-contianer h-full mx-auto py-4 font-titleFont flex items-center justify-between">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="/public/assets/MernEmanSarwarAlamResume.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        {showMenu && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.1 }}
              className="w-[80%] h-full overflow-y-scroll scrollbarHide bg-[#112240] flex flex-col items-center fx-4 py-10 relative"
            >
              <MdOutlineClose
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <a href="/assets/EmanSarwarAlamResume.pdf" target="_blank">
                  <motion.button
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                <div className="flex gap-4">
                  ...
                  <motion.a
                    ...
                    href="https://www.linkedin.com/in/emansarwaralam/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px]   hover:border-textGreen text-zinc-200 border-zinc-700  rounded-full inline-flex items-center justify-center  hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialLinkedin />
                  ...
                  <motion.a
                    ...
                    href="https://www.facebook.com/emansarwar.emu"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px]   hover:border-textGreen text-zinc-200 border-zinc-700  rounded-full inline-flex items-center justify-center  hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialFacebook />
